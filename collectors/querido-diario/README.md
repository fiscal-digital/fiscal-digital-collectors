...
- **EventBridge cron:** `cron(7 7 ? * MON-FRI *)` UTC (segunda a sexta, 07:07 UTC = 04:07 BRT — fora do minuto cheio, por cortesia com a API pública do Querido Diário). Diarios oficiais raramente publicam fim de semana — auditoria de 14 dias (24/05 a 07/06/2026) confirmou zero ingest em sab/dom.
